...
T = {
    ...
    "subtotal_no_vat": "الإجمالي بدون ضريبة",
    "total_with_vat": "الإجمالي شامل الضريبة",
    "cash_total": "إجمالي النقد",
    "card_total": "إجمالي البطاقة",
    "open_tables_section": "الطاولات المفتوحة (غير المدفوعة)",
    "open_tables_count": "عدد الطاولات المفتوحة",
    "open_tables_due": "المبلغ المستحق من الطاولات المفتوحة",
    "opened": "وقت الفتح",
